...
const destinations = [
    ...
    },
    {
        ...
        // CẬP NHẬT ĐƯỜNG DẪN ẢNH THỰC TẾ
        images: [
            'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?q=80&w=1000&auto=format&fit=crop', // Ảnh Núi Phú Sĩ sạch
    'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?q=80&w=1000&auto=format&fit=crop'  // Ảnh Phố cổ Kyoto sạch
        ]
    }
];
